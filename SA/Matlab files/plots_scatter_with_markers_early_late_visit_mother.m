...
boxplot([ Ma; Mb],[ones(length(Ma),1);2*ones(length(Mb),1)],'Color','k','Symbol','')
hold on
scatter(1*ones(1,length(Ma)),Ma,1000,'filled','b','MarkerFaceColor',col_bl,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
scatter(2*ones(1,length(Mb)),Mb,1000,'filled','b','MarkerFaceColor',col_bl,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
