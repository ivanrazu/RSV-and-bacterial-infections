...
# Load data
data_infants <- read_excel("GAM_virus_MC_RSV_infants.xlsx")
data_mothers <- read_excel("GAM_virus_MC_RSV_mothers.xlsx")
...
# ggsave(file = "GAM_virus_infants_MC_RSV.png",
#        plot = plot1,
...
k_values2 <- seq(3, 6)  # Range of k values from 3 to 12. Had to increase and lower k
...
# Save the plot as a PNG file
# ggsave(file = "GAM_virus_mothers_MC_RSV.png",
#        plot = plot2,
#        width = 8,  # Width in inches
#        height = 6,  # Height in inches
#        units = "in",  # Specify units as inches
