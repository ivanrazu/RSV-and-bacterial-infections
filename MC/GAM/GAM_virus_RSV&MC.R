...
# Load data
data_infants <- read_excel("GAM_virus_RSV&MC_infants.xlsx")
data_mothers <- read_excel("GAM_virus_RSV&MC_mothers.xlsx")
...
# ggsave(file = "GAM_virus_infants_RSV&MC_v2.png",
#        plot = plot1,
...
#Higher k resulted in over fitting
...
# Save the plot as a PNG file
# ggsave(file = "GAM_virus_mothers_RSV&MC.png",
#        plot = plot2,
#        width = 8,  # Width in inches
#        height = 6,  # Height in inches
#        units = "in",  # Specify units as inches
