...
% loads info from RSV->MC
load('MtxGroup3_child_with_demographic_data.mat','MtxGroup3_child');


M3=MtxGroup3_child;

% % Subjects who came up MC+ in the following visit immedially after detection of RSV
M3subjects1=[14;50;71;81;339;342;352;411];

% %Subjects who came up MC+ in the second  or later visit after detection of RSV
M3subjects2=[19;90;225;349;627;671;1656];
...
M3_MC_day3a=nonzeros(M3_MC_day3a);
M3_MC_day4a=nonzeros(M3_MC_day4a);
M3_MC_day5a=nonzeros(M3_MC_day5a);

Ma=[M3_MC_day1a;M3_MC_day2a;M3_MC_day3a;M3_MC_day4a;M3_MC_day5a];
%%
...
M3_MC_day3b=nonzeros(M3_MC_day3b);
M3_MC_day4b=nonzeros(M3_MC_day4b);

MMC_alldays=M3.MC_Ct_Mean;
MMC_alldays=MMC_alldays(MMC_alldays>0);

Mb=[M3_MC_day1b;M3_MC_day2b;M3_MC_day3b;M3_MC_day4b];
