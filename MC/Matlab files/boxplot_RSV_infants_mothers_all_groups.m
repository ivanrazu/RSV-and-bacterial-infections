...
h=boxplot([MM1m.RSV_Ct;MM2m.RSV_Ct;MM3m.RSV_Ct;MM4m.RSV_Ct],...
    [ones(size(MM1m.RSV_Ct,1),1);2*ones(size(MM2m.RSV_Ct,1),1);...
    3*ones(size(MM3m.RSV_Ct,1),1);4*ones(size(MM4m.RSV_Ct,1),1)],'Color','k','Symbol','');

hold on;
scatter(1*ones(1,length(MM1m.RSV_Ct)),MM1m.RSV_Ct,1000,'d','filled','MarkerFaceColor',col_bl,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
scatter(2*ones(1,length(MM2m.RSV_Ct)),MM2m.RSV_Ct,1000,'d','filled','MarkerFaceColor',col_bl,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
scatter(3*ones(1,length(MM3m.RSV_Ct)),MM3m.RSV_Ct,1000,'d','filled','MarkerFaceColor',col_bl,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
scatter(4*ones(1,length(MM4m.RSV_Ct)),MM4m.RSV_Ct,1000,'d','filled','MarkerFaceColor',col_bl,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
plot([1,2,3,4],[mean(MM1m.RSV_Ct(MM1m.RSV_Ct>0)),mean(MM2m.RSV_Ct(MM2m.RSV_Ct>0)),...
...
set(gca, 'XTickLabel', {'MC$\rightarrow$RSV','MC\&RSV','RSV$\rightarrow$MC','RSV'},'TickLabelInterpreter','latex','Fontsize',43)
ylabel('RSV Ct','Interpreter','latex','Fontsize',60)
...
[h1m,p1m]=ttest2(MM1m.RSV_Ct,MM2m.RSV_Ct);
[h2m,p2m]=ttest2(MM1m.RSV_Ct,MM3m.RSV_Ct);
[h3m,p3m]=ttest2(MM1m.RSV_Ct,MM4m.RSV_Ct);  %%%%% p=0.0417
[h4m,p4m]=ttest2(MM2m.RSV_Ct,MM3m.RSV_Ct);
[h5m,p5m]=ttest2(MM2m.RSV_Ct,MM4m.RSV_Ct);
...
group_comparisons={'MC->RSV	vs MC&RSV  ', 'MC->RSV	vs RSV->MC ' , 'MC->RSV vs RSV   ', 'MC&RSV  vs RSV->MC ', 'MC&RSV vs RSV', 'RSV->MC vs RSV'};
...
%% Wilcoxon rank sum test for Mothers
[pwm1,hwm1,statswm1] = ranksum(MM1m.RSV_Ct,MM2m.RSV_Ct); 
[pwm2,hwm2,statswm2] = ranksum(MM1m.RSV_Ct,MM3m.RSV_Ct); 
[pwm3,hwm3,statswm3] = ranksum(MM1m.RSV_Ct,MM4m.RSV_Ct); 
[pwm4,hwm4,statswm4] = ranksum(MM2m.RSV_Ct,MM3m.RSV_Ct); 
[pwm5,hwm5,statswm5] = ranksum(MM2m.RSV_Ct,MM4m.RSV_Ct);  
...
hold on;
scatter(1*ones(1,length(MM1c.RSV_Ct)),MM1c.RSV_Ct,1000,'d','filled','MarkerFaceColor',col_blk,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
scatter(2*ones(1,length(MM2c.RSV_Ct)),MM2c.RSV_Ct,1000,'d','filled','MarkerFaceColor',col_blk,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
scatter(3*ones(1,length(MM3c.RSV_Ct)),MM3c.RSV_Ct,1000,'d','filled','MarkerFaceColor',col_blk,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
scatter(4*ones(1,length(MM4c.RSV_Ct)),MM4c.RSV_Ct,1000,'d','filled','MarkerFaceColor',col_blk,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
...
set(gca,'Fontsize',60);box on;
set(gca, 'XTickLabel', {'MC$\rightarrow$RSV','MC\&RSV','RSV$\rightarrow$MC','RSV'},'TickLabelInterpreter','latex','Fontsize',50)
ylabel('RSV Ct','Interpreter','latex','Fontsize',60)
set(findobj(gca,'type','line'),'linew',4)
set(gca,'linew',4)
xtickangle(30)
...
[h1c,p1c]=ttest2(MM1c.RSV_Ct,MM2c.RSV_Ct);
[h2c,p2c]=ttest2(MM1c.RSV_Ct,MM3c.RSV_Ct);
[h3c,p3c]=ttest2(MM1c.RSV_Ct,MM4c.RSV_Ct);
[h4c,p4c]=ttest2(MM2c.RSV_Ct,MM3c.RSV_Ct);
[h5c,p5c]=ttest2(MM2c.RSV_Ct,MM4c.RSV_Ct);
[h6c,p6c]=ttest2(MM3c.RSV_Ct,MM4c.RSV_Ct);
