...
hold on
scatter(ones(length(Mt1.age_days_SP_acquisition),1),Mt1.age_days_SP_acquisition,1000,'filled','MarkerFaceColor',col_blk,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
scatter(2*ones(length(Mt2.age_days_SP_acquisition),1),Mt2.age_days_SP_acquisition,1000,'filled','MarkerFaceColor',col_blk,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
scatter(3*ones(length(Mt3.age_days_SP_acquisition),1),Mt3.age_days_SP_acquisition,1000,'filled','MarkerFaceColor',col_blk,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
scatter(4*ones(length(Mt5.age_days_SP_acquisition),1),Mt5.age_days_SP_acquisition,1000,'filled','MarkerFaceColor',col_blk,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
...
xlim([0.5,4.5])
xticks((1:1:4))
 set(gca, 'XTickLabel', {'SP$\rightarrow$RSV','SP\&RSV','RSV$\rightarrow$SP','SP'},'TickLabelInterpreter','latex','Fontsize',43)
...
% saveas(gcf,'boxplot_SP_acquisition_infants_v2.png');
...
% [h1a,p1a]=ttest2(Mt2.age_days_SP_acquisition,Mt3.age_days_SP_acquisition);%%%%%%%%%  p= 0.0276
% [h2a,p2a]=ttest2(Mt2.age_days_SP_acquisition,Mt5.age_days_SP_acquisition);%%%%%%%%%  p= 0.0383
...
avergae_acquisition_M1_2_3=mean([Mt1.age_days_SP_acquisition;Mt2.age_days_SP_acquisition;Mt3.age_days_SP_acquisition]);
...
fprintf('The average SP acquisition time for infants in SP->RSV,SP&RSV,RSV->SP is: %f\n',avergae_acquisition_M1_2_3)
% Calculate the confidence interval
confidenceInterval_M1_2_3 = calculateConfidenceInterval([Mt1.age_days_SP_acquisition;Mt2.age_days_SP_acquisition;Mt3.age_days_SP_acquisition]);
