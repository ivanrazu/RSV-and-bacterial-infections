...
% yticks((20:10:40))
% set(gca, 'YTickLabel', {'20','30','40'},'TickLabelInterpreter','latex')
...
%saveas(gca,'boxplot_mothers_SP_rightafter_RSV_v4.png')

%% Statistics

% t-test 
[h,p]=ttest2(Ma,Mb); %%% p= 0.3447

% Wilcoxon rank sum test
[p1a,h1a]=ranksum(Ma,Mb) %%% p= 0.5714
