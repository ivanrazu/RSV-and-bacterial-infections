%Plots boxplots of RSV CT on Mothers only and infants only
...
scatter(4,MM4m.RSV_Ct,1000,'d','filled','MarkerFaceColor',col_bl,'MarkerFaceAlpha',0.6','jitter','on','jitterAmount',0.15);
hold on
...
yxis_reverse=1;
set(gca, 'XTickLabel', {'SP$\rightarrow$RSV','SP\&RSV','RSV$\rightarrow$SP','RSV'},'TickLabelInterpreter','latex','Fontsize',50)

ylabel('RSV Ct','Interpreter','latex','FontSize',45)
...
group_comparisons={'SP->RSV	vs SP&RSV  ', 'SP->RSV	vs RSV->SP ' , 'SP->RSV vs RSV   ', 'SP&RSV  vs RSV->SP ', 'SP&RSV vs RSV     ', 'RSV->SP vs RSV   '};
...
%% Wilcoxon rank sum test among mothers 
...
boxplot([MM1c.RSV_Ct;MM2c.RSV_Ct;MM3c.RSV_Ct;MM4c.RSV_Ct],...
