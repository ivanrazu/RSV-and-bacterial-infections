...
# Load data
data_infants <- read_excel("C:/Users/ivanr/Documents/SAMIPS Project/RSV_SP_summarized/GAM_RSV&SP_Infants.xlsx")
data_mothers <- read_excel("C:/Users/ivanr/Documents/SAMIPS Project/RSV_SP_summarized/GAM_RSV&SP_Mothers.xlsx")
...
# ggsave(file = "C:/Users/ivanr/Documents/SAMIPS Project/RSV_SP_summarized/GAM_infants_RSV&SP_v2.png",
#        plot = plot1,
...
# Save the plot as a PNG file
# ggsave(file = "C:/Users/ivanr/Documents/SAMIPS Project/RSV_SP_summarized/GAM_mothers_RSV&SP_v2.png",
#        plot = plot2,
#        width = 8,  # Width in inches
#        height = 6,  # Height in inches
#        units = "in",  # Specify units as inches
