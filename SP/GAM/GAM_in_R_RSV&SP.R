...
# Load data
data_infants <- read_excel("GAM_RSV&SP_Infants.xlsx")
data_mothers <- read_excel("GAM_RSV&SP_Mothers.xlsx")
...
# ggsave(file = "GAM_infants_RSV&SP.png",
#        plot = plot1,
...
# Save the plot as a PNG file
# ggsave(file = "GAM_mothers_RSV&SP.png",
#        plot = plot2,
#        width = 8,  # Width in inches
#        height = 6,  # Height in inches
#        units = "in",  # Specify units as inches
