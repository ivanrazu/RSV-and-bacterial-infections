...
# Load data
data_infants <- read_excel("~/SAMIPS Project/RSV_SP_summarized/GAM_RSV_SP_Infants.xlsx")
data_mothers <- read_excel("~/SAMIPS Project/RSV_SP_summarized/GAM_RSV_SP_Mothers.xlsx")
...
# ggsave(file = "~/GAM_infants_RSV_SP_v2.png",
#        plot = plot1,
...
# # Save the plot as a PNG file
# ggsave(file = "~/GAM_mothers_RSV_SP_v2.png",
#        plot = plot2,
#        width = 8,  # Width in inches
#        height = 6,  # Height in inches
#        units = "in",  # Specify units as inches
