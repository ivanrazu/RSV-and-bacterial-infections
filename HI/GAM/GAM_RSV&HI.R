...
# Load data
data_infants <- read_excel("GAM_RSV&HI_Infants.xlsx")
data_mothers <- read_excel("GAM_RSV&HI_Mothers.xlsx")
...
k_values <- seq(3, 6)  # Range of k values from 3 to 12. Had to increase and lower k
...
# ggsave(file = "GAM_infants_RSV&HI.png",
#        plot = plot1,
...
# Since there are only 2 data points linear model is the only option
...
# Save the plot as a PNG file
# ggsave(file = "GAM_mothers_RSV&HI.png",
#        plot = plot2,
#        width = 8,  # Width in inches
#        height = 6,  # Height in inches
#        units = "in",  # Specify units as inches
