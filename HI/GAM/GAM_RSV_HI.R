...
# Load data
data_infants <- read_excel("GAM_RSV_HI_infants.xlsx")
data_mothers <- read_excel("GAM_RSV_HI_mothers.xlsx")
...
k_values <- seq(3, 10)  # Range of k values from 3 to 12. Had to increase and lower k
...
# ggsave(file = "GAM_infants_RSV_HI.png",
#        plot = plot1,
...
k_values2 <- seq(3, 4)  # Range of k values from 3 to 12. Had to increase and lower k
...
# Save the plot as a PNG file
# ggsave(file = "GAM_mothers_RSV_HI.png",
#        plot = plot2,
#        width = 8,  # Width in inches
#        height = 6,  # Height in inches
#        units = "in",  # Specify units as inches
