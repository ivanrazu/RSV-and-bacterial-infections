...
%% T-test
[h1,p1]=ttest2(M1a_new.HI_CT,M1b_new.HI_CT); %%% p=0.4845
[h2,p2]=ttest2(M2a_new.HI_CT,M2b_new.HI_CT); %%% p=0.0535
[h3,p3]=ttest2(M3a_new.HI_CT,M3b_new.HI_CT); %%% p=0.4845
[h4,p4]=ttest2(M5a_new.HI_CT,M5b_new.HI_CT); %%% p= 0.4866

%%
[p1a,h1a]=ranksum(M1a_new.HI_CT,M1b_new.HI_CT); %% p = 0.666667
[p2a,h2a]=ranksum(M2a_new.HI_CT,M2b_new.HI_CT); %% p=0.333333
[p3a,h3a]=ranksum(M3a_new.HI_CT,M3b_new.HI_CT); %% p=0.730769
[p4a,h4a]=ranksum(M5a_new.HI_CT,M5b_new.HI_CT); %% p=0.658992
...
group_labels = {'HI->RSV', 'RSV&HI', 'RSV->HI', 'HI only'};
...
hold on;
scatter(1*ones(1,length(M1a_new.HI_CT)), M1a_new.HI_CT, dot_size, 'filled', 'MarkerFaceColor', col_blk, 'MarkerFaceAlpha', 0.6,'jitter','on','jitterAmount',0.15);
hold on;
scatter(2*ones(1,length(M1b_new.HI_CT)), M1b_new.HI_CT, dot_size, 'filled', 'MarkerFaceColor', col_blk, 'MarkerFaceAlpha', 0.6,'jitter','on','jitterAmount',0.15);
hold on;
scatter(4*ones(1,length(M2a_new.HI_CT)), M2a_new.HI_CT, dot_size, 'filled', 'MarkerFaceColor', col_blk, 'MarkerFaceAlpha', 0.6,'jitter','on','jitterAmount',0.15);
hold on;
scatter(5*ones(1,length(M2b_new.HI_CT)), M2b_new.HI_CT, dot_size, 'filled', 'MarkerFaceColor', col_blk, 'MarkerFaceAlpha', 0.6,'jitter','on','jitterAmount',0.15);
hold on;
scatter(7*ones(1,length(M3a_new.HI_CT)), M3a_new.HI_CT, dot_size, 'filled', 'MarkerFaceColor', col_blk, 'MarkerFaceAlpha', 0.6,'jitter','on','jitterAmount',0.15);
hold on;
scatter(8*ones(1,length(M3b_new.HI_CT)), M3b_new.HI_CT, dot_size, 'filled', 'MarkerFaceColor', col_blk, 'MarkerFaceAlpha', 0.6,'jitter','on','jitterAmount',0.15);
hold on;
scatter(10*ones(1,length(M5a_new.HI_CT)), M5a_new.HI_CT, dot_size, 'filled', 'MarkerFaceColor', col_blk, 'MarkerFaceAlpha', 0.6,'jitter','on','jitterAmount',0.15);
hold on;
scatter(11*ones(1,length(M5b_new.HI_CT)), M5b_new.HI_CT, dot_size, 'filled', 'MarkerFaceColor', col_blk, 'MarkerFaceAlpha', 0.6,'jitter','on','jitterAmount',0.15);
hold on;
